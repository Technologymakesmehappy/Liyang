...
public class Spark
{
	...
	static readonly int material_FlowZ = Shader.PropertyToID("_FlowZ");
	...
	public void render(int front, Camera camera, double render_time, float flow_z)
	{
		if (material_ == null) {
			return;
		}
		...
		material_.SetFloat(material_FlowZ, flow_z*0.5f);
